...
<body>
    ...
    <form action="" method="post">
        <table border="1" cellspacing="0" cellpadding="5" style="margin:auto;  background: rgba(0,0,0,0.5); border:3px solid black; width:400px; height:500px;">
            <tr>
                <td colspan="3" style="text-align: center;"><h2>MASUKKAN DATA KOPI ANDA</h2></td>
            </tr>
            <tr>
                <th>Nama Kopi</th>
                <td>:</td>
            ...
            <tr>
                <td colspan="3" style="text-align: center;"><button type="submit" name="submit">Kirim</button> | <button type="submit" name="submit"><a href="index.php">Kembali</a></button></td>
            </tr>
